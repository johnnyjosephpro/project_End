...
def create_database():
    ...
    mycursor = mdb.cursor(requete1, requete2)
    mycursor.execute("")
...
def open_window2():
    ...
    sexe = tk.IntVar()
    buttonM = Radiobutton(window2, text="Masculin", variable=sexe, value=0, font=("Century Gothic", 12), fg="WHITE", bg="#3b3b3b", command=sexe.get()).place(x=35, y=195)
    buttonF = Radiobutton(window2, text="Feminin", variable=sexe, value=1, font=(
        "Century Gothic", 12), fg="WHITE", bg="#3b3b3b", command=sexe.get()).place(x=140, y=195)
